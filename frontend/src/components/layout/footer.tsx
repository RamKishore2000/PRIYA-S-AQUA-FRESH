...
const socialLinks = [
  {
    label: "WhatsApp",
    href: "https://wa.me/919121043483",
    icon: WhatsAppIcon,
    colorClass: "text-[#25d366]",
  },
  {
    label: "Facebook",
    href: "https://www.facebook.com/priyasaquafresh",
    icon: FacebookIcon,
    colorClass: "text-[#1877f2]",
  },
  {
    label: "YouTube",
    href: "https://www.youtube.com/@priyasaquafresh",
    icon: YouTubeIcon,
    colorClass: "text-[#ff0000]",
  },
  {
    label: "Instagram",
    href: "https://www.instagram.com/priyasaquafresh",
    icon: InstagramIcon,
    colorClass: "text-[#e4405f]",
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/priyas-aqua-fresh",
    icon: LinkedInIcon,
    colorClass: "text-[#0a66c2]",
  },
  {
    label: "X",
    href: "https://x.com/priyasaquafresh",
    icon: XIcon,
