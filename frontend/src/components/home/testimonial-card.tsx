  ...
  return (
    <article className="h-full rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-3">
        <div className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-teal-100 text-sm font-bold text-teal-800">
        ...
        <div>
          ...
          <p className="flex items-center gap-1 text-xs font-semibold text-teal-700">
            <BadgeCheck className="h-3.5 w-3.5" /> {testimonial.role || "Verified buyer"}
          </p>
        </div>
      </div>
