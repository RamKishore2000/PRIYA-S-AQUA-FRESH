...
export function CategoryItem({ category }: { category: Category }) {
  return (
    <Link
      ...
      className="group relative block w-[238px] shrink-0 overflow-hidden rounded-[1.1rem] border border-white/10 bg-[#13201d] px-3 py-3 shadow-[0_18px_48px_rgba(0,0,0,0.28)] transition duration-500 hover:-translate-y-1 hover:border-[#12a8e6]/45 hover:bg-[#182825] hover:shadow-[0_24px_70px_rgba(0,0,0,0.38)] sm:w-[270px] sm:rounded-[1.35rem] sm:px-4 sm:py-4 lg:w-[300px]"
    >
      ...
      <span className="relative flex min-h-[96px] items-center gap-3 sm:min-h-[112px] sm:gap-4">
        <span className="relative block h-[90px] w-[98px] shrink-0 transition duration-500 group-hover:-translate-x-1 group-hover:-translate-y-1 group-hover:scale-[1.05] sm:h-[104px] sm:w-[116px]">
        ...
        <span className="relative min-w-0 flex-1 text-left">
          <span className="block text-xs font-bold leading-4 text-[#12a8e6] transition duration-300 group-hover:text-[#49cfff] sm:text-sm sm:leading-5">
            {category.name}
          </span>
