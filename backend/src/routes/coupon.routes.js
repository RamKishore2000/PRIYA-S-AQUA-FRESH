...
const { couponIdValidator, couponPayloadValidator, couponValidatePayloadValidator, couponStatusValidator } = require("../validators/coupon.validator");
...
router.post("/validate", couponValidatePayloadValidator, validateRequest, asyncHandler(couponController.validateCoupon));
