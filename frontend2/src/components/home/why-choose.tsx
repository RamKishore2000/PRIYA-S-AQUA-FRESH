...
export function WhyChoose() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-[#F3FAFF] px-4 py-8 text-white md:px-6 md:py-10">
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-[1.35rem] border border-[#D8EAF8] bg-[linear-gradient(115deg,#073133_0%,#06282A_48%,#083C3A_100%)] p-3 shadow-[0_18px_45px_rgba(28,43,38,0.18)]">
          ...
          <div className="pointer-events-none absolute left-[8%] top-0 h-full w-[28%] rounded-t-full border border-[#0057C8]/35 opacity-45" />
          <div className="relative grid gap-5 rounded-[1rem] border border-[#28B463]/35 p-4 md:p-5 lg:grid-cols-[0.92fr_0.9fr_0.86fr] lg:items-center">
            <div data-why-image className="relative min-h-[260px] overflow-hidden rounded-[0.9rem] bg-[linear-gradient(135deg,rgba(255,249,241,0.12),rgba(255,255,255,0.02))] md:min-h-[310px] lg:min-h-[330px]">
              ...
              <div className="absolute bottom-5 left-1/2 h-16 w-[74%] -translate-x-1/2 rounded-[100%] bg-[#FFFFFF]/90 shadow-[0_18px_46px_rgba(0,0,0,0.28)]" />
              <div className="absolute left-7 top-10 h-32 w-16 rounded-full border border-[#28B463]/25" />
            ...
            <div data-why-reveal className="px-1 lg:px-3">
              <p className="text-xs font-black uppercase tracking-[0.24em] text-[#28B463]">Why We Are</p>
              <h2 className="mt-3 font-serif text-3xl font-semibold leading-tight text-[#FFFFFF] md:text-4xl">
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-2">
              {stats.map((stat) => {
                ...
                return (
                  <article key={stat.label} data-why-reveal className="rounded-xl border border-[#28B463] bg-[#FFFFFF] p-4 text-[#253636] shadow-[0_10px_26px_rgba(0,0,0,0.16)] transition duration-500 hover:-translate-y-1 hover:shadow-[0_16px_34px_rgba(216,184,121,0.22)]">
